...
public class StopWatchPanel extends JPanel implements ActionListener, Runnable {
  ...
  private static final String SOUND_PIKA = "pika.wav";
  private Thread timerThread;
  private long lastSecsLeft = 0;
  ...
  public void run() {
    try {
      while (running) {
        ...
        if (timeLeft > 0 && timeLeft <= 10000 && secsLeft != lastSecsLeft) {
